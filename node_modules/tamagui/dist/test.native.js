...
var require_Collection_native = __commonJS({
  "../collection/dist/cjs/Collection.native.js"(exports, module2) {
    ...
    var import_compose_refs = require_index_native5(), import_core12 = require_index_native15(), import_react2 = __toESM2(require("react")), import_jsx_runtime6 = require("react/jsx-runtime");
...
var require_getElevation_native = __commonJS({
  "../stacks/dist/cjs/getElevation.native.js"(exports, module2) {
    ...
    var import_core12 = require_index_native15(), getElevation = (size2, extras) => {
      if (!size2)
        return;
...
var require_Stacks_native = __commonJS({
  "../stacks/dist/cjs/Stacks.native.js"(exports, module2) {
    ...
    var import_core12 = require_index_native15(), import_getElevation = require_getElevation_native(), fullscreenStyle = {
      position: "absolute",
      top: 0,
      left: 0,
      right: 0,
    ...
    }, YStack3 = (0, import_core12.styled)(import_core12.Stack, {
      flexDirection: "column",
      variants
    }), XStack = (0, import_core12.styled)(import_core12.Stack, {
      flexDirection: "row",
      variants
    }), ZStack = (0, import_core12.styled)(
      YStack3,
      {
        position: "relative"
      },
...
var require_SizableStack_native = __commonJS({
  "../stacks/dist/cjs/SizableStack.native.js"(exports, module2) {
    ...
    var import_core12 = require_index_native15(), import_get_button_sized2 = require_index_native18(), import_Stacks = require_Stacks_native(), import_variants = require_variants_native(), SizableStack = (0, import_core12.styled)(import_Stacks.XStack, {
      name: "SizableStack",
      variants: {
        unstyled: {
          true: {
...
var require_ThemeableStack_native = __commonJS({
  "../stacks/dist/cjs/ThemeableStack.native.js"(exports, module2) {
    ...
    var import_core12 = require_index_native15(), import_Stacks = require_Stacks_native(), import_variants = require_variants_native(), chromelessStyle = {
...
var require_index_native20 = __commonJS({
  "../get-font-sized/dist/cjs/index.native.js"(exports, module2) {
    ...
    module2.exports = __toCommonJS2(src_exports2);
    var import_core12 = require_index_native15(), getFontSized2 = (sizeTokenIn = "$true", { font, fontFamily, props }) => {
      var _a, _b, _c, _d, _e, _f;
      if (!font)
        return;
...
var require_Adapt_native = __commonJS({
  "../adapt/dist/cjs/Adapt.native.js"(exports, module2) {
    ...
    var import_core12 = require_index_native15(), import_react2 = require("react"), import_jsx_runtime6 = require("react/jsx-runtime"), AdaptParentContext = (0, import_react2.createContext)(null), AdaptContents = (props) => {
...
var require_GorhomPortal_native = __commonJS({
  "../portal/dist/cjs/GorhomPortal.native.js"(exports, module2) {
    ...
    var import_core12 = require_index_native15(), import_react2 = __toESM2(require("react")), import_jsx_runtime6 = require("react/jsx-runtime"), ACTIONS = /* @__PURE__ */ ((ACTIONS2) => (ACTIONS2[ACTIONS2.REGISTER_HOST = 0] = "REGISTER_HOST", ACTIONS2[ACTIONS2.DEREGISTER_HOST = 1] = "DEREGISTER_HOST", ACTIONS2[ACTIONS2.ADD_UPDATE_PORTAL = 2] = "ADD_UPDATE_PORTAL", ACTIONS2[ACTIONS2.REMOVE_PORTAL = 3] = "REMOVE_PORTAL", ACTIONS2))(ACTIONS || {}), INITIAL_STATE = {}, registerHost = (state, hostName) => (hostName in state || (state[hostName] = []), state), deregisterHost = (state, hostName) => (delete state[hostName], state), addUpdatePortal = (state, hostName, portalName, node) => {
...
var require_constants_native3 = __commonJS({
  "../sheet/dist/cjs/constants.native.js"(exports, module2) {
    ...
    module2.exports = __toCommonJS2(constants_exports);
    var import_core12 = require_index_native15(), constants = {}, SHEET_NAME = "Sheet", SHEET_HANDLE_NAME = "SheetHandle", SHEET_OVERLAY_NAME = "SheetOverlay", SHEET_HIDDEN_STYLESHEET = import_core12.isClient ? document.createElement("style") : null;
...
var require_useSheetProviderProps_native = __commonJS({
  "../sheet/dist/cjs/useSheetProviderProps.native.js"(exports, module2) {
    ...
    var import_core12 = require_index_native15(), import_use_constant = require_index_native31(), import_use_controllable_state = require_index_native12(), import_react2 = __toESM2(require("react"));
  ...
  "../sheet/dist/cjs/SheetImplementationCustom.native.js"(exports, module2) {
    ...
    var import_adapt = require_index_native24(), import_animate_presence = require_index_native11(), import_compose_refs = require_index_native5(), import_core12 = require_index_native15(), import_portal2 = require_index_native29(), import_use_keyboard_visible = require_index_native32(), import_react2 = require("react"), import_react_native4 = require("react-native"), import_constants = require_constants_native3(), import_contexts = require_contexts_native(), import_helpers = require_helpers_native(), import_SheetContext = require_SheetContext_native(), import_useSheetOpenState = require_useSheetOpenState_native(), import_useSheetProviderProps = require_useSheetProviderProps_native(), import_jsx_runtime6 = require("react/jsx-runtime"), hiddenSize = 10000.1, SheetImplementationCustom = (0, import_core12.themeable)(
      (0, import_react2.forwardRef)(function(props, forwardedRef) {
        ...
        ), { animationDriver } = (0, import_core12.useConfiguration)(), { useAnimatedNumber, useAnimatedNumberStyle, useAnimatedNumberReaction } = animationDriver, AnimatedView = animationDriver.View;
...
var require_SheetScrollView_native = __commonJS({
  "../sheet/dist/cjs/SheetScrollView.native.js"(exports, module2) {
    ...
    var import_core12 = require_index_native15(), import_scroll_view = require_index_native33(), import_react2 = require("react"), import_SheetContext = require_SheetContext_native(), import_jsx_runtime6 = require("react/jsx-runtime"), SHEET_SCROLL_VIEW_NAME = "SheetScrollView", SheetScrollView = (0, import_react2.forwardRef)(
    ...
    function createSheet({ Handle, Frame, Overlay }) {
      let SheetHandle = Handle.extractable(
        ...
        (0, import_react2.memo)((propsIn) => {
          ...
          return (0, import_core12.useIsomorphicLayoutEffect)(() => {
            var _a;
      ...
      }, Controlled = (0, import_core12.withStaticProperties)(Sheet, components);
      return (0, import_core12.withStaticProperties)(Sheet, {
        ...components,
        Controlled
      });
    }
...
var require_Sheet_native = __commonJS({
  "../sheet/dist/cjs/Sheet.native.js"(exports, module2) {
    ...
    var import_core12 = require_index_native15(), import_stacks3 = require_index_native19(), import_constants = require_constants_native3(), import_createSheet = require_createSheet_native(), import_SheetContext = require_SheetContext_native();
...
var require_SheetController_native = __commonJS({
  "../sheet/dist/cjs/SheetController.native.js"(exports, module2) {
    ...
    var import_core12 = require_index_native15(), import_react2 = require("react"), import_useSheetController = require_useSheetController_native(), import_jsx_runtime6 = require("react/jsx-runtime"), SheetController = ({
      children,
  ...
  "../dialog/dist/cjs/Dialog.native.js"(exports, module2) {
    ...
    var DialogContentModal = React2.forwardRef(
      ...
      (props, forwardedRef) => {
        ...
        return showSheet ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(DialogPortalItem, { hostName: getSheetContentsName(context), children: contentProps.children }) : import_core12.isWeb ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
...
var require_AlertDialog_native = __commonJS({
  "../alert-dialog/dist/cjs/AlertDialog.native.js"(exports, module2) {
    ...
    var import_compose_refs = require_index_native5(), import_core12 = require_index_native15(), import_create_context = require_index_native25(), import_dialog = require_index_native35(), import_use_controllable_state = require_index_native12(), React2 = __toESM2(require("react")), import_react_native4 = require("react-native"), import_jsx_runtime6 = require("react/jsx-runtime"), ROOT_NAME = "AlertDialog", [createAlertDialogContext, createAlertDialogScope] = (0, import_create_context.createContextScope)(ROOT_NAME, [
      ...
      (props, forwardedRef) => {
        if (props.__native) {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
            ...
            {
              ...rest,
              onPress: (0, import_core12.composeEventHandlers)(onPress, __onPress)
            }
          );
        }
          ...
          import_dialog.DialogWarningProvider,
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(AlertDialogContentProvider, { scope: __scopeAlertDialog, cancelRef, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
              import_dialog.DialogContent,
              {
                ...
                ...contentProps,
                ref: composedRefs,
                onOpenAutoFocus: (0, import_core12.composeEventHandlers)(
                  contentProps.onOpenAutoFocus,
                  (event) => {
                    var _a;
                    event.preventDefault(), import_core12.isWeb && ((_a = cancelRef.current) == null || _a.focus({ preventScroll: !0 }));
                  }
                ),
...
var require_Image_native = __commonJS({
  "../image/dist/cjs/Image.native.js"(exports, module2) {
    ...
    var import_core12 = require_index_native15(), import_react2 = require("react"), import_react_native4 = require("react-native"), import_jsx_runtime6 = require("react/jsx-runtime"), StyledImage = (0, import_core12.styled)(import_react_native4.Image, {
      name: "Image",
      position: "relative",
      source: { uri: "" }
    }), Image = StyledImage.extractable(
      (0, import_react2.forwardRef)((inProps, ref) => {
        let [props, style] = (0, import_core12.usePropsAndStyle)(inProps), { src, source, ...rest } = props, finalSource = typeof src == "string" ? { uri: src, ...import_core12.isWeb && { width: props.width, height: props.height } } : source ?? src;
...
var require_getFontSize_native = __commonJS({
  "../font-size/dist/cjs/getFontSize.native.js"(exports, module2) {
    ...
    var import_core12 = require_index_native15(), getFontSize = (inSize, opts) => {
...
var require_Checkbox_native = __commonJS({
  "../checkbox/dist/cjs/Checkbox.native.js"(exports, module2) {
    ...
    var import_core12 = require_index_native15(), import_create_context = require_index_native25(), import_focusable2 = require_index_native44(), import_font_size = require_index_native40(), import_get_token2 = require_index_native17(), import_helpers_tamagui = require_index_native41(), import_label = require_index_native45(), import_stacks3 = require_index_native19(), import_use_controllable_state = require_index_native12(), import_use_previous = require_index_native46(), React2 = __toESM2(require("react")), import_jsx_runtime6 = require("react/jsx-runtime"), CheckboxStyledContext = (0, import_core12.createStyledContext)({
      size: "$true",
      scaleIcon: 1
    });
          ...
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
            CheckboxFrame,
            {
              ...
              ...import_core12.isWeb && {
                type: "button",
                value,
                onKeyDown: (0, import_core12.composeEventHandlers)(
                  props.onKeyDown,
                  (event) => {
              ...
              onPress: (0, import_core12.composeEventHandlers)(props.onPress, (event) => {
                setChecked(
    ...
    ), Checkbox2 = (0, import_core12.withStaticProperties)(CheckboxComponent, {
...
var require_Popper_native = __commonJS({
  "../popper/dist/cjs/Popper.native.js"(exports, module2) {
    ...
    function Popper(props) {
      ...
      if ((0, import_core12.useIsomorphicLayoutEffect)(() => {
        floating.refs.setReference(anchorRef);
      }, [anchorRef]), import_core12.isWeb)
        (0, import_core12.useIsomorphicLayoutEffect)(() => {
  ...
  "../popover/dist/cjs/Popover.native.js"(exports, module2) {
    ...
    var PopoverContentImpl = React2.forwardRef(function(props, forwardedRef) {
      let {
        ...
        ...contentProps
      } = props, context = usePopoverContext(__scopePopover), { open, keepChildrenMounted } = context, popperContext = (0, import_popper.usePopperContext)(__scopePopover || POPOVER_SCOPE), [isFullyHidden, setIsFullyHidden] = React2.useState(!context.open), contents = React2.useMemo(() => import_core12.isWeb ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: { display: "contents" }, children }) : children, [children]);
    ...
    }), Popover = (0, import_core12.withStaticProperties)(
      function(props) {
        let {
          children,
          open: openProp,
...
var require_Progress_native = __commonJS({
  "../progress/dist/cjs/Progress.native.js"(exports, module2) {
    ...
    }), Progress = (0, import_core12.withStaticProperties)(
            ...
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
              RadioGroupItemFrame,
              {
                ...
                ...import_core12.isWeb && {
                  ...
                  onFocus: (0, import_core12.composeEventHandlers)(itemProps.onFocus, () => {
                    var _a;
...
var require_Separator_native = __commonJS({
  "../separator/dist/cjs/Separator.native.js"(exports, module2) {
    ...
    var import_core12 = require_index_native15(), Separator = (0, import_core12.styled)(import_core12.Stack, {
      name: "Separator",
      borderColor: "$borderColor",
      flexShrink: 0,
      borderWidth: 0,
      ...
      variants: {
        vertical: {
          true: {
            y: 0,
            x: -0.5,
            height: import_core12.isWeb ? "initial" : "auto",
            ...
            maxHeight: import_core12.isWeb ? "initial" : "auto",
            width: 0,
            maxWidth: 0,
            borderBottomWidth: 0,
            borderRightWidth: 1
...
var require_SelectItem_native = __commonJS({
  "../select/dist/cjs/SelectItem.native.js"(exports, module2) {
    ...
    var import_compose_refs = require_index_native5(), import_core12 = require_index_native15(), import_list_item = require_index_native51(), React2 = __toESM2(require("react")), import_context = require_context_native(), import_jsx_runtime6 = require("react/jsx-runtime"), ITEM_NAME = "SelectItem", [SelectItemContextProvider, useSelectItemContext] = (0, import_context.createSelectContext)(ITEM_NAME), SelectItem = React2.forwardRef(
      (props, forwardedRef) => {
        let {
          __scopeSelect,
          value,
...
var require_SelectViewport_native = __commonJS({
  "../select/dist/cjs/SelectViewport.native.js"(exports, module2) {
    ...
    var import_adapt = require_index_native24(), import_core12 = require_index_native15(), import_portal2 = require_index_native29(), React2 = __toESM2(require("react")), import_constants = require_constants_native4(), import_context = require_context_native(), import_jsx_runtime6 = require("react/jsx-runtime"), SelectViewport = (props) => {
...
var require_useSelectBreakpointActive_native = __commonJS({
  "../select/dist/cjs/useSelectBreakpointActive.native.js"(exports, module2) {
    ...
    var import_core12 = require_index_native15(), useSelectBreakpointActive = (sheetBreakpoint) => {
      let media = (0, import_core12.useMedia)();
...
var require_Select_native = __commonJS({
  "../select/dist/cjs/Select.native.js"(exports, module2) {
    ...
    }, SelectSheetImpl = (props) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_jsx_runtime6.Fragment, { children: props.children }), Select = (0, import_core12.withStaticProperties)(
      (props) => {
        let {
          __scopeSelect,
          native,
        ...
        let shouldRenderWebNative = import_core12.isWeb && (native === !0 || native === "web" || Array.isArray(native) && native.includes("web"));
...
var require_SliderImpl_native = __commonJS({
  "../slider/dist/cjs/SliderImpl.native.js"(exports, module2) {
    ...
    }), SliderFrame2 = (0, import_core12.styled)(DirectionalYStack2, {
      position: "relative",
      variants: {
        size: (val, extras) => {
          if (!val)
      ...
      (props, forwardedRef) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
          SliderFrame2,
          {
            ...
            onResponderGrant: (0, import_core12.composeEventHandlers)(props.onResponderGrant, (event) => {
              let target = event.target, isStartingOnThumb = context.thumbs.has(target);
              import_core12.isWeb && target instanceof HTMLElement && context.thumbs.has(target) && target.focus(), onSlideStart(event, isStartingOnThumb ? "thumb" : "track");
            }),
            onResponderMove: (0, import_core12.composeEventHandlers)(props.onResponderMove, (event) => {
              event.stopPropagation(), onSlideMove(event);
            }),
            onResponderRelease: (0, import_core12.composeEventHandlers)(props.onResponderRelease, (event) => {
              onSlideEnd(event);
            })
          }
        );
  ...
  "../slider/dist/cjs/Slider.native.js"(exports, module2) {
    ...
    var import_compose_refs = require_index_native5(), import_core12 = require_index_native15(), import_get_token2 = require_index_native17(), import_helpers = require_index_native4(), import_stacks3 = require_index_native19(), import_use_controllable_state = require_index_native12(), import_use_direction = require_index_native22(), React2 = __toESM2(require("react")), import_constants = require_constants_native5(), import_helpers2 = require_helpers_native2(), import_SliderImpl = require_SliderImpl_native(), import_jsx_runtime6 = require("react/jsx-runtime"), SliderHorizontal = React2.forwardRef(
      (props, forwardedRef) => {
        ...
        return import_core12.isClient && useOnDebouncedWindowResize(measure), /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
      ...
      variants: {
        ...
        unstyled: {
          false: {
            ...
            borderWidth: 2,
            backgrounded: !0,
            pressTheme: import_core12.isWeb,
            focusTheme: import_core12.isWeb,
            hoverTheme: import_core12.isWeb
          }
        }
      },
      defaultVariants: {
    ...
    ), Slider = (0, import_core12.withStaticProperties)(SliderComponent, {
      Track: SliderTrack,
...
var require_SwitchContext_native = __commonJS({
  "../switch/dist/cjs/SwitchContext.native.js"(exports, module2) {
    ...
    var import_core12 = require_index_native15(), SwitchContext = (0, import_core12.createStyledContext)({
      checked: !1,
      disabled: !1,
      size: void 0,
      frameWidth: 0,
...
var require_Switch_native = __commonJS({
  "../switch/dist/cjs/Switch.native.js"(exports, module2) {
    ...
    var import_core12 = require_index_native15(), import_get_token2 = require_index_native17(), import_stacks3 = require_index_native19(), import_SwitchContext = require_SwitchContext_native(), SwitchThumb = (0, import_core12.styled)(import_stacks3.ThemeableStack, {
      name: "SwitchThumb",
...
var require_RovingFocusGroup_native = __commonJS({
  "../roving-focus/dist/cjs/RovingFocusGroup.native.js"(exports, module2) {
    ...
    var import_core12 = require_index_native15(), import_react2 = __toESM2(require("react")), import_jsx_runtime6 = require("react/jsx-runtime"), ITEM_NAME = "RovingFocusGroupItem", RovingFocusGroupItem = import_react2.default.forwardRef(
...
var require_Tooltip_native = __commonJS({
  "../tooltip/dist/cjs/Tooltip.native.js"(exports, module2) {
    ...
    var import_core12 = require_index_native15(), RenderChildren = (props) => props.children, RenderNull = (props) => null, Tooltip = (0, import_core12.withStaticProperties)(RenderChildren, {
...
}, InputFrame = (0, import_core7.styled)(
...
// src/index.ts
var import_core11 = __toESM(require_index_native15());
