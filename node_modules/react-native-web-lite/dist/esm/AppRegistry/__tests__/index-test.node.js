...
describe("AppRegistry", () => {
  describe("getApplication", () => {
    test("does not throw when missing appParameters", () => {
      ...
      const { element, getStyleElement } = AppRegistry.getApplication("App", {}), styleElement = ReactDOMServer.renderToStaticMarkup(getStyleElement());
      ...
      AppRegistry.registerComponent("App", () => NoopComponent);
      const { getStyleElement } = AppRegistry.getApplication("App", {}), styleElement = getStyleElement({ nonce });
      ...
      }), AlternativeComponent = () => React.createElement(View, { style: styles.root });
