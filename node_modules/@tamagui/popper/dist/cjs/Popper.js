...
const PopperAnchor = import_stacks.YStack.extractable(
  ...
  var _a, _b;
  const { __scopePopper, ...rest } = propsIn, props = (0, import_core.useProps)(rest), { offset, size: sizeProp, borderWidth = 0, ...arrowProps } = props, context = usePopperContext(__scopePopper), sizeVal = sizeProp ?? context.size, size = +(0, import_core.getVariableValue)(
