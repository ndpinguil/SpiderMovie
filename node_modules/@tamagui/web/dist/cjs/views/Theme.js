...
function wrapThemeElements({
  ...
  const themeColor = (_b = themeState.state) != null && _b.theme && themeState.isNewTheme ? (0, import_createVariable.variableToString)(themeState.state.theme.color) : "", colorStyle = themeColor ? {
    color: themeColor
  } : void 0;
  let className = ((_c = themeState.state) == null ? void 0 : _c.className) || "";
  ...
  if (inverse != null || forceClassName) {
    const name = ((_d = themeState.state) == null ? void 0 : _d.name) || "";
