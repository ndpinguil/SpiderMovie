...
describe("StyleSheet", () => {
  test("getSheet", () => {
    ...
    test("empty", () => {
      ...
      `);
      const styles2 = StyleSheet.create({ test: { marginVertical: "40px" } }), inlineStyle2 = { margin: "8px", marginVertical: "40px" };
      ...
      const inlineA = { start: "12.34%" }, inlineB = { textAlign: "start" }, inlineC = { marginEnd: 10 }, a = StyleSheet.create({ x: { ...inlineA } }).x, b = StyleSheet.create({ x: { ...inlineB } }).x, c = StyleSheet.create({ x: { ...inlineC } }).x, writingDirection = "rtl", inlineStyle = [inlineA, inlineB, inlineC];
