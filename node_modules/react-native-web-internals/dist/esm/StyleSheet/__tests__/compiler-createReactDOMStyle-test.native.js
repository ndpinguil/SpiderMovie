...
describe("compiler/createReactDOMStyle", () => {
  test("noop on DOM styles", () => {
    const firstStyle = createReactDOMStyle(reactNativeStyle), secondStyle = createReactDOMStyle(firstStyle);
    ...
    test("general case", () => {
      ...
      expect(createReactDOMStyle({ fontFamily: "Noto, BlinkMacSystemFont" })).toMatchInlineSnapshot(`
        {
    ...
    test("string", () => {
      const transform = "perspective(50px) scaleX(20) translateX(20px) rotate(20deg)", resolved = createReactDOMStyle({ transform });
