...
describe("create-event-handle", () => {
  ...
  beforeEach(() => {
    ...
    const listener = jest.fn(), targetRef = React.createRef(), addClickListener = createEventHandle("click");
    function Component() {
      return React.useEffect(() => addClickListener(targetRef.current, listener)), /* @__PURE__ */ jsx("div", { ref: targetRef });
    }
    ...
    test("event dispatched on target", () => {
      ...
      const listener = jest.fn(), listenerCapture = jest.fn(), targetRef = React.createRef(), parentRef = React.createRef(), addClickListener = createEventHandle("click"), addClickCaptureListener = createEventHandle("click", {
        capture: !0
      });
      function Component() {
      ...
      const log = [], listener = jest.fn(() => {
        ...
        log.push("capture");
      }), targetRef = React.createRef(), childRef = React.createRef(), addClickListener = createEventHandle("click"), addClickCaptureListener = createEventHandle("click", {
        capture: !0
      });
      function Component() {
        return React.useEffect(() => {
      ...
      const listener = jest.fn(), targetRef = React.createRef(), childRef = React.createRef(), addClickListener = createEventHandle("click");
      function Component() {
        return React.useEffect(() => addClickListener(targetRef.current, listener)), /* @__PURE__ */ jsx("div", { ref: targetRef, children: /* @__PURE__ */ jsx("div", { ref: childRef, children: "text" }) });
      }
      act(() => {
        root.render(/* @__PURE__ */ jsx(Component, {}));
      });
      ...
      function Component({ target: target2 }) {
        return React.useEffect(() => addClickListener(target2, listener)), /* @__PURE__ */ jsx("div", { ref: targetRef });
      }
      act(() => {
      ...
      const listener = jest.fn(), targetRef = React.createRef(), addMagicEventListener = createEventHandle("magic-event");
      function Component() {
        return React.useEffect(() => addMagicEventListener(targetRef.current, listener)), /* @__PURE__ */ jsx("div", { ref: targetRef });
      }
      act(() => {
        root.render(/* @__PURE__ */ jsx(Component, {}));
      }), act(() => {
      ...
      const log = [], targetRef = React.createRef(), parentRef = React.createRef(), childRef = React.createRef(), addClickListener = createEventHandle("click"), addClickCaptureListener = createEventHandle("click", {
        capture: !0
      }), listener = jest.fn((e) => {
      ...
      const log = [], targetRef = React.createRef(), childRef = React.createRef(), addClickListener = createEventHandle("click"), addClickAltListener = createEventHandle("click"), addClickCaptureListener = createEventHandle("click", {
        capture: !0
    ...
    test("stopPropagation works as expected", () => {
      const childListener = jest.fn((e) => {
        e.stopPropagation();
      }), targetListener = jest.fn(), targetRef = React.createRef(), childRef = React.createRef(), addClickListener = createEventHandle("click");
      function Component() {
        return React.useEffect(() => {
      ...
      }), secondListener = jest.fn(), targetRef = React.createRef(), addFirstClickListener = createEventHandle("click"), addSecondClickListener = createEventHandle("click");
      function Component() {
        return React.useEffect(() => {
