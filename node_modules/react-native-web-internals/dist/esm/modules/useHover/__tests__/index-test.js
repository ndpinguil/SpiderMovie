  ...
  beforeEach(() => {
    ...
    const componentInit = () => {
      ...
      const Component = () => (useHover(ref, {
        ...
        onHoverUpdate,
        onHoverEnd
      }), useHover(childRef, { contain: !0 }), /* @__PURE__ */ jsx("div", { ref, children: /* @__PURE__ */ jsx("div", { ref: childRef }) }));
      act(() => {
    ...
    test("contains the hover gesture", () => {
      componentInit();
      const target = createEventTarget(ref.current), child = createEventTarget(childRef.current);
      act(() => {
    ...
    const componentInit = () => {
      ...
      const Component = () => (useHover(ref, { onHoverStart }), /* @__PURE__ */ jsx("div", { ref }));
      act(() => {
        root.render(/* @__PURE__ */ jsx(Component, {}));
      });
    };
    ...
    const componentInit = () => {
      ...
      const Component = () => (useHover(ref, { onHoverChange }), /* @__PURE__ */ jsx("div", { ref }));
      act(() => {
        root.render(/* @__PURE__ */ jsx(Component, {}));
      });
    };
    ...
    const componentInit = () => {
      ...
      const Component = () => (useHover(ref, { onHoverEnd }), /* @__PURE__ */ jsx("div", { ref, children: /* @__PURE__ */ jsx("div", { ref: childRef }) }));
      act(() => {
        root.render(/* @__PURE__ */ jsx(Component, {}));
      });
    };
    ...
    test('is called after the active pointer moves"', () => {
      const onHoverUpdate = jest.fn(), ref = React.createRef(), Component = () => (useHover(ref, { onHoverUpdate }), /* @__PURE__ */ jsx("div", { ref }));
      act(() => {
        root.render(/* @__PURE__ */ jsx(Component, {}));
      });
      const target = createEventTarget(ref.current);
