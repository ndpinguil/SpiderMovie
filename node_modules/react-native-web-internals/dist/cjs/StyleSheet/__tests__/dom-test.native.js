...
describe("createSheet", () => {
  test("creates a sheet on the client", () => {
    ...
    const iframeDoc = iframe.contentWindow.document, iframeRootTag = document.createElement("div");
    iframeDoc.body.appendChild(iframeRootTag);
    const iframeSheet = (0, import_dom.createSheet)(iframeRootTag);
    ...
    const shadowRoot = document.createElement("div").attachShadow({ mode: "open" }), shadowRootTag = document.createElement("div");
    shadowRoot.appendChild(shadowRootTag), document.body.appendChild(shadowRoot);
    const shadowSheet = (0, import_dom.createSheet)(shadowRootTag);
